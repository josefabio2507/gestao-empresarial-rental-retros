...
MODULO_OPERACAO_VEICULOS = "gestao_veiculos_epgs"


@veiculos_equipamentos_bp.route("/")
@login_required
@module_permission_required("operacao", MODULO_OPERACAO_VEICULOS, "visualizar")
def index():
    return render_template("operacao/gestao_veiculos_epgs/index.html")
...
@login_required
@module_permission_required("operacao", MODULO_OPERACAO_VEICULOS, "criar")
def novo():
...
@login_required
@module_permission_required("operacao", MODULO_OPERACAO_VEICULOS, "editar")
...
@login_required
@module_permission_required("operacao", MODULO_OPERACAO_VEICULOS, "excluir")
