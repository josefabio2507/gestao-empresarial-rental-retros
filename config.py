...
class Config:
    ...
    AUTO_SEED_SUPRIMENTOS_UNIDADES_ON_START = os.getenv(
        "AUTO_SEED_SUPRIMENTOS_UNIDADES_ON_START",
        "true" if SQLALCHEMY_DATABASE_URI.startswith("postgresql://") else "false",
    ).lower() == "true"
    AUTO_SEED_SUPRIMENTOS_ITENS_ON_START = os.getenv(
        "AUTO_SEED_SUPRIMENTOS_ITENS_ON_START",
        "true" if SQLALCHEMY_DATABASE_URI.startswith("postgresql://") else "false",
    ).lower() == "true"
    ...
    GOOGLE_OAUTH_CLIENT_SECRET = os.getenv("GOOGLE_OAUTH_CLIENT_SECRET", os.getenv("GOOGLE_CLIENT_SECRET", "")).strip()
    GOOGLE_OAUTH_REFRESH_TOKEN = os.getenv("GOOGLE_OAUTH_REFRESH_TOKEN", os.getenv("GOOGLE_REFRESH_TOKEN", "")).strip()
    GOOGLE_OAUTH_TOKEN_URI = os.getenv("GOOGLE_OAUTH_TOKEN_URI", "").strip()
