...
"""
    ...
    def test_xml_manifestacao_usa_assinatura_compativel_com_schema_nfe(self):
        ...
        evento = xml_raiz.find("{http://www.portalfiscal.inf.br/nfe}evento")
        self.assertIsNotNone(evento.find("{http://www.w3.org/2000/09/xmldsig#}Signature"))
        self.assertIsNone(inf_evento.find("{http://www.w3.org/2000/09/xmldsig#}Signature"))
        self.assertEqual(["infEvento", "Signature"], [etree.QName(filho).localname for filho in evento])
